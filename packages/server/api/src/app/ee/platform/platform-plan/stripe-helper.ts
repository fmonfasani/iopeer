import {  ApSubscriptionStatus, BillingCycle, CreateSubscriptionParams, PlanName, StripePlanName } from '@IOpeer/ee-shared'
import { AppSystemProp, WorkerSystemProp } from '@IOpeer/server-shared'
import { ApEdition, assertNotNullOrUndefined, isNil, PlatformRole, UserWithMetaInformation } from '@IOpeer/shared'
...
export const stripeHelper = (log: FastifyBaseLogger) => ({
    ...
    async createPortalSessionUrl(platformId: string): Promise<string> {
        ...
        const session = await stripe.billingPortal.sessions.create({
            ...
            return_url: 'https://cloud.iopeer.com/platform/billing',
        })
