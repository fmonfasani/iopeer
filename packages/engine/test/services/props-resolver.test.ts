import { ApFile, PieceAuth, Property } from '@IOpeer/pieces-framework'
import { FlowActionType, FlowTriggerType, GenericStepOutput, PropertyExecutionType, PropertySettings, StepOutputStatus } from '@IOpeer/shared'
...
describe('Props resolver', () => {
    ...
    it('should resolve files inside the array properties', async () => {
        const input = {
            documents: [
                {
                    file: 'https://cdn.IOpeer.com/brand/logo.svg?token=123',
                },
            ],
        }
        const props = {
