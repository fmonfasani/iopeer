...
> = {
  [FlowActionType.CODE]: {
    displayName: t('Code'),
    logoUrl: 'https://cdn.iopeer.com/pieces/code.svg',
  ...
  [FlowTriggerType.EMPTY]: {
    ...
    logoUrl: 'https://cdn.iopeer.com/pieces/empty-trigger.svg',
