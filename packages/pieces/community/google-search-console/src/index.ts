...
export const googleSearchConsoleAuth = PieceAuth.OAuth2({
  ...
  12. Add https://cloud.IOpeer.com/redirect in **Authorized redirect URIs** field, and click on the Create button.
...
export const googleSearchConsolePiece = createPiece({
  ...
  logoUrl: 'https://cdn.IOpeer.com/pieces/google-search-console.png',
