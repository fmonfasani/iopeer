    ...
    import { createPiece, PieceAuth, OAuth2PropertyValue } from "@IOpeer/pieces-framework";
    import { OAuth2GrantType, PieceCategory } from '@IOpeer/shared';
    ...
    export const harvest = createPiece({
      ...
      logoUrl: "https://cdn.IOpeer.com/pieces/harvest.png",
