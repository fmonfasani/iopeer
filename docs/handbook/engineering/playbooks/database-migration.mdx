...
description: "Guide for creating database migrations in IOPeer"
icon: "database"
---

IOPeer uses TypeORM as its database driver in Node.js. We support two database types across different editions of our platform.
