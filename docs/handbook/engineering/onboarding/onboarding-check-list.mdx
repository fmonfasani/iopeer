...
- [ ] Set up your @iopeer.com email account and setup 2FA
- [ ] Confirm access to out private Discord server.
- [ ] Get Invited to the IOPeer Github Organization and Setup 2FA
...
Welcome again to the team. We can't wait to see the impact you'll make at IOPeer! 😉
