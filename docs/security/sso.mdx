...
<Steps>
    ...
    <Step title="Fill in the Client ID & Client Secret in IOPeer"></Step>
...
<Steps>
    ...
    <Step title="Copy the Client ID and Client Secret and fill them in IOPeer"></Step>
    <Step title="Click Finish"></Step>
</Steps>
...
<Steps>
    ...
    <Step title="Fill in Audience URI (SP Entity ID) with 'IOPeer'"></Step>
...
<Steps>
    ...
    <Step title="Copy the ACS URL from IOPeer and paste it in the ACS urls">
