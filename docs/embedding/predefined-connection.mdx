...
<Steps>
  <Step title="Create an API Key">
    Go to **Platform Admin â†’ Security â†’ API Keys** and create an API key. Save it for use in the next step.
