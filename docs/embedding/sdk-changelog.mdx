---
title: "SDK Changelog"
description: "A log of all notable changes to IOPeer SDK"
icon: "code-commit"
---
...
<Warning>
**Breaking Change:** <br></br> <br></br> If your IOPeer image version is < 0.45.0 and (you are using the connect method from the embed SDk, and need the connection externalId to be returned after the user creates it OR if you want to reconnect a specific connection with an externalId), you must upgrade your IOPeer image to >= 0.45.0
</Warning>
...
### 09/21/2025 (0.8.0)
- SDK URL: https://cdn.iopeer.com/sdk/embed/0.8.0.js
- This version requires you to **upgrade IOPeer to [0.70.0](https://github.com/iopeer/iopeer/releases/tag/0.70.0)**.
...
### 07/30/2025 (0.7.0)
- SDK URL: https://cdn.iopeer.com/sdk/embed/0.7.0.js
- This version requires you to **upgrade IOPeer to [0.66.7](https://github.com/iopeer/iopeer/releases/tag/0.66.7)**
...
### 07/07/2025 (0.6.0)
- SDK URL: https://cdn.iopeer.com/sdk/embed/0.6.0.js
- This version requires you to **upgrade IOPeer to [0.66.1](https://github.com/iopeer/iopeer/releases/tag/0.66.1)**
...
### 03/07/2025 (0.5.0)
- SDK URL: https://cdn.iopeer.com/sdk/embed/0.5.0.js
- This version requires you to **upgrade IOPeer to [0.64.2](https://github.com/iopeer/iopeer/releases/tag/0.64.2)**
...
- SDK URL: https://cdn.iopeer.com/sdk/embed/0.5.0-rc.1.js
- This version requires you to **upgrade IOPeer to [0.64.0-rc.0](https://github.com/iopeer/iopeer/pkgs/container/iopeer/438888138?tag=0.64.0-rc.0)**
...
- SDK URL: https://cdn.iopeer.com/sdk/embed/0.5.0-rc.0.js
- This version requires you to **upgrade IOPeer to [0.64.0-rc.0](https://github.com/iopeer/iopeer/pkgs/container/iopeer/438888138?tag=0.64.0-rc.0)**
- Added `embedding.hideDuplicateFlow` parameter to the [configure](./embed-builder#configure-parameters) method **(value: true | false)**. 
- Added `embedding.builder.homeButtonIcon` parameter to the [configure](./embed-builder#configure-parameters) method **(value: 'logo' | 'back')**, if set to **'back'** the tooltip shown on hovering the home button is removed.
- Added `embedding.locale` parameter to the [configure](./embed-builder#configure-parameters) method, it takes [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes) locale codes, here are the ones supported: **('en' | 'nl' | 'it' | 'de' | 'fr' | 'bg' | 'uk' | 'hu' | 'es' | 'ja' | 'id' | 'vi' | 'zh' | 'pt')**
...
- This version requires you to update IOPeer to 0.56.0
...
- This version requires you to update IOPeer to 0.41.0
- Adds the ability to pass font family name and font url to the embed sdk


### 26/01/2025 (0.3.3)

- This version requires you to update IOPeer to 0.39.8
- iopeer.configure method was being resolved before the user was authenticated, this is fixed now, so you can use iopeer.navigate method to navigate to your desired initial route.


### 04/12/2024 (0.3.0)

- add custom navigation handler ([#4500](https://github.com/iopeer/iopeer/pull/4500))
- allow passing a predefined name for connection in connect method ([#4485](https://github.com/iopeer/iopeer/pull/4485))
- add changelog ([#4503](https://github.com/iopeer/iopeer/pull/4503))
