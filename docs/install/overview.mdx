...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install IOPeer"
---

IOPeer Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.
...
Deploy IOPeer as a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy IOPeer with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  ...
  } href="https://www.pikapods.com/pods?run=iopeer">
...
<CardGroup cols={2}>
  <Card title="IOPeer Cloud" icon="cloud" color="##5155D7" href="https://cloud.iopeer.com/">
