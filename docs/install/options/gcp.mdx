...
This documentation is to deploy iopeer on VM Instance or VM Instance Group, we should first create VM template
...
After a successful deployment, you can access the IOPeer application by visiting the external IP address of the VM on GCP.

## Production Deployment

Please visit [IOPeer](/install/configuration/environment-variables) for more details on how to customize the application.