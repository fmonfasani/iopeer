...
**1. Clone IOPeer repository.**

Use the command line to clone IOPeer repository:
...
To upgrade to new versions, which are installed using docker compose, perform the following steps. First, open a terminal in the iopeer repository directory and run the following commands.
