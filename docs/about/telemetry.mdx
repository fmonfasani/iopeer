...
To ensure we can continue to improve our product, we have decided to track certain basic behaviors and metrics that are vital for understanding the usage of IOPeer.

We have implemented a minimal tracking plan and provide a detailed list of the metrics collected in a separate section.


# What Does IOPeer Collect?
...
[Exact Code](https://github.com/iopeer/iopeer/blob/main/packages/shared/src/lib/common/telemetry.ts)
