...
title: "MCP"
icon: 'brain'
description: "Give AI access to your tools through IOPeer"
---
...
To use MCPs on IOPeer, we'll let you connect any of our [open source MCP tools](https://www.iopeer.com/mcp), and give you an MCP Server URL. Then, you'll configure your LLM to work with it.

## Use IOPeer MCP Server

1. **You need to run IOPeer.** It can run on our cloud or you can self-host it in your machine or infrastructure.

   ***Both options are for free, and all our MCP tools are open source.***

<CardGroup cols={2}>
  <Card title="IOPeer Cloud (Easy)" icon="cloud" color="#00FFFF" href="https://cloud.iopeer.com/sign-up">
Use our cloud to run your MCP tools, or to just give it a test drive
  ...
  <Card title="Self-hosting" icon="download" color="#248fe0" href="/install/overview">
    Deploy IOPeer using Docker or one of the other methods
  </Card>

</CardGroup>

2. **Connect your tools.** Go to AI → MCP in your IOPeer Dashboard, and start connecting the tools that you want to give AI access to.
